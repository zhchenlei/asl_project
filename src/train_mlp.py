...
def parse_args():
    ...
    p.add_argument("--out_dir", type=str, default="artifacts/mlp")
...
def main():
    ...
    model = compile_model(build_mlp(), lr=args.lr, weight_decay=args.weight_decay)
    ...
    print(f"[MLP] test_accuracy={metrics['test_accuracy']:.4f}  saved={metrics['export_dir']}")
